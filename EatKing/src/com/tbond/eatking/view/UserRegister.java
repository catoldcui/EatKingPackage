...
//        StrictMode.setThreadPolicy(policy);
        ...
        register_submit.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                // TODO Auto-generated method stub
                JsonAnalysis.getInstance().regis(userRegister, register_username.getText().toString().trim(), register_passwd.getText().toString().trim());
            }
        });
    }
    
    public void setToast(String messageString){
    	 Toast.makeText(UserRegister.this, messageString, Toast.LENGTH_SHORT).show(); 
    	 if(messageString.equals("注册成功")){
    		 finish();
    	 }
    }
